...
\usepackage[opticals,medfamily,minionint,footnotefigures]{}
...
\usepackage[dvipdfm, bookmarks, colorlinks, breaklinks, pdftitle={ },pdfauthor={Michael Malecki}]{hyperref}  
...
\begin{document}
\input{sweaveTemplate-concordance}
...
%%% Inline use with results=tex, just watch spacing.
% The data comprise 
% <<numobs,results=tex,echo=FALSE>>=
% cat("25") # use something like nrow(foo) here
% @ 
%  observations.
...
% \begin{figure}[htb]
%   \centering
%   \caption{Sample of 1000 draws from an Inverse-gamma (10,10), the
%     default prior distribution given to the variance of the augmented
%     dichotomous data. This parameter expansion greatly improves the
%     sampler's efficiency.}
%   \label{fig:ig-latent-data-prior}
% <<ig-latent-prior,fig=TRUE,pdf=TRUE,eps=FALSE,echo=FALSE,width=7,height=4>>=
% print(histogram(1/rgamma(1000,10,10),breaks=30,
%           scales=list(tck=c(1,0)), # no top/right ticks
%           par.settings=list(
%             plot.polygon=list(col="#00000044"),
